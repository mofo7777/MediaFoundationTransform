...
inline LPCWSTR MFTMessageString(MFT_MESSAGE_TYPE msg){
	...
	switch(msg){
		...
		RETURN_STRING(MFT_MESSAGE_DROP_SAMPLES);
		RETURN_STRING(MFT_MESSAGE_COMMAND_TICK);
		...
		RETURN_STRING(MFT_MESSAGE_NOTIFY_RELEASE_RESOURCES);
		RETURN_STRING(MFT_MESSAGE_NOTIFY_REACQUIRE_RESOURCES);
		RETURN_STRING(MFT_MESSAGE_NOTIFY_EVENT);
		RETURN_STRING(MFT_MESSAGE_COMMAND_SET_OUTPUT_STREAM_STATE);
		RETURN_STRING(MFT_MESSAGE_COMMAND_FLUSH_OUTPUT_STREAM);
		RETURN_STRING(MFT_MESSAGE_COMMAND_MARKER);
...
inline LPCWSTR MFTTransformAttributeString(REFGUID guidAttribute){

	IF_EQUAL_RETURN(guidAttribute, MF_ACTIVATE_MFT_LOCKED);
	IF_EQUAL_RETURN(guidAttribute, MF_SA_D3D_AWARE);
	IF_EQUAL_RETURN(guidAttribute, MF_TRANSFORM_ASYNC);
	IF_EQUAL_RETURN(guidAttribute, MF_TRANSFORM_ASYNC_UNLOCK);
	IF_EQUAL_RETURN(guidAttribute, MF_TRANSFORM_CATEGORY_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MF_TRANSFORM_FLAGS_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_CODEC_MERIT_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_CONNECTED_STREAM_ATTRIBUTE);
	IF_EQUAL_RETURN(guidAttribute, MFT_CONNECTED_TO_HW_STREAM);
	IF_EQUAL_RETURN(guidAttribute, MFT_DECODER_EXPOSE_OUTPUT_TYPES_IN_NATIVE_ORDER);
	IF_EQUAL_RETURN(guidAttribute, MFT_DECODER_FINAL_VIDEO_RESOLUTION_HINT);
	IF_EQUAL_RETURN(guidAttribute, MFT_ENCODER_SUPPORTS_CONFIG_EVENT);
	IF_EQUAL_RETURN(guidAttribute, MFT_ENUM_ADAPTER_LUID);
	IF_EQUAL_RETURN(guidAttribute, MFT_ENUM_HARDWARE_URL_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_ENUM_HARDWARE_VENDOR_ID_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_ENUM_TRANSCODE_ONLY_ATTRIBUTE);
	IF_EQUAL_RETURN(guidAttribute, MFT_FIELDOFUSE_UNLOCK_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_FRIENDLY_NAME_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_INPUT_TYPES_Attributes);
	IF_EQUAL_RETURN(guidAttribute, MFT_OUTPUT_TYPES_Attributes);
	IF_EQUAL_RETURN(guidAttribute, MFT_PREFERRED_ENCODER_PROFILE);
	IF_EQUAL_RETURN(guidAttribute, MFT_PREFERRED_OUTPUTTYPE_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_PREFERRED_OUTPUTTYPE_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_PROCESS_LOCAL_Attribute);
	IF_EQUAL_RETURN(guidAttribute, MFT_REMUX_MARK_I_PICTURE_AS_CLEAN_POINT);
	IF_EQUAL_RETURN(guidAttribute, MFT_SUPPORT_3DVIDEO);
	IF_EQUAL_RETURN(guidAttribute, MFT_SUPPORT_DYNAMIC_FORMAT_CHANGE);
	IF_EQUAL_RETURN(guidAttribute, MFT_TRANSFORM_CLSID_Attribute);
...
#define MFTTransformAttributeString(x) L""
#endif
